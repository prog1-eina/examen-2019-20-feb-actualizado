 ...
 *       es igual o anterior al primer evento del flujo «ultimos». Análogamente,
 *       el último terremoto de «ultimos» es igual o posterior al primer
 ...
 * 
 * Post: Tras ser ejecucado, este programa ha actualizado los datos del 
